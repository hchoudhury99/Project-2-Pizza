...
namespace PizzaWeb.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentId,CardNumber,ExpireDate,CVV,CustomerID")] Payment payment)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(_url);
                //HTTP GET
                // PizzaAPI.Controllers.CustomerController c = new PizzaAPI.Controllers.CustomerController(_context);
                var postTask = client.PostAsJsonAsync("Payments", payment);
                postTask.Wait();
