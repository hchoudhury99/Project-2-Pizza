            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PizzaId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    PizzaName = table.Column<int>(nullable: true),
                    Size = table.Column<int>(nullable: false),
                    Crust = table.Column<int>(nullable: false),
                    Sauce = table.Column<int>(nullable: false),
                    Topping1 = table.Column<int>(nullable: true),
                    Topping2 = table.Column<int>(nullable: true),
                    Topping3 = table.Column<int>(nullable: true),
